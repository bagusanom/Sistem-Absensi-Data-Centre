  ...
  <nav class="navbar bgnav">
            ...
            <br>
              <div class="row row-cols-1 row-cols-md-2 g-4  ">
                ...
                <div class="col margin animationLeft">
                  <a class="card border opacity-85" href="cs.php">
              ...
              <div class="row g-4 container pt-2 btn-animated ">
                <button class="btn btn-primary" type="button"><a class="btno" href="csshow.php">Kirim Gambar</a></button>
              </div>
    ...
    <?php
        ...
        //Query input menginput data kedalam tabel barang
          $sql="insert into cleaning_service (id, nama,instansi,notelp,kepentingan,waktu_masuk,status) values
