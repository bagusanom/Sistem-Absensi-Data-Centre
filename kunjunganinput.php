...
<html lang="en">
  ...
  <nav class="navbar bgnav">
            ...
            <br>
              <div class="row row-cols-1 row-cols-md-2 g-4  ">
                ...
                <div class="col margin animationLeft">
                  <a class="card border opacity-85">
              ...
              <div class="row g-4 container pt-2 btn-animated ">
                <button class="btn btn-primary" type="button"><a class="btno" href="kunjunganshow.php">Kirim Gambar</a></button>
              </div>
    ...
    <?php
        ...
        $jmlh=mysqli_query($conn, "SELECT * FROM kunjungan WHERE 1");
        ...
        //Query input menginput data kedalam tabel barang
          $sql="insert into kunjungan (id, nama,instansi,notelp,kepentingan,waktu_masuk,status) values
