...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="sources/stel.css">
            ...
            <div class="rowo pt-2 row-cols-1 row-cols-md-2 g-4 justify-content-center  ">
                  ...
                  <div class="col margin">
                    <a class="card border opacity-85 btn-animated">
                        <h5 class="card-title align">Visitor</h5>
                    </a>
                  </div>
            </div>
          </div>
            ...
            <div class="rowo justify-content-center ">
              <table width="100%" class="table card border opacity-85  margin btn-animated" >
                    <div class="">
                      ...
                      <?php
                      include 'koneksi.php';
                      $pengguna = mysqli_query($conn, "SELECT * from maintenance WHERE status=TRUE");
                      $no=1;
                      foreach ($pengguna as $row){
                          echo "<tr>
                              ...
                              <td><a href='logout.php?id=".$row['id']."'>Logout</a></td>
                              </tr>";
                          $no++;
                      }
                      ?>
