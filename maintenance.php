  ...
  <nav class="navbar bgnav">
    ...
    <br>
      ...
      <div class="container pt-5">
        <form action="maintenanceinput.php" method="get">
          <div class="form-floating mb-3 btn-animated">
            <input type="text" class="form-control" id="nama" placeholder="..." name="nama">
            <label for="nama">Nama Lengkap</label>
          </div>
          <div class="form-floating mb-3 btn-animated">
            <input type="text" class="form-control" id="instansi" placeholder="..." name="instansi">
            <label for="instansi">Instansi</label>
          </div>
          <div class="form-floating mb-3 btn-animated">
            <input type="text" class="form-control" id="notelp" placeholder="..." name="notelp">
            <label for="instansi">Nomor Telepon</label>
          </div>
          <div class="form-floating mb-3 btn-animated">
            <textarea class="form-control" placeholder="..." id="kepentingan" name="kepentingan"></textarea>
            <label for="kepentingan">Kepentingan</label>
          </div>
          <div class="row g-4 container pt-5 btn-animated ">
